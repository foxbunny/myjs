...
(function (global, factory) {
  ...
  var my = {
    ...
    isIterable: function(v) {
      return Array.isArray(v) || (typeof v === 'object' && v.length);
    },
    ...
    fire: function (evt, data, Ctor) {
      ...
      if (typeof Ctor === 'object') {
        // This must be IE
        var ctorName = Ctor.toString().split(' ')[1].slice(0, -1);
        e = window.document.createEvent(ctorName);
     ...
     * ## `append(node)
     *
     * Append one or more nodes to root node.
     *
     * @param {object} node - DOM node or array thereof
     */
     ...
     * ## `prepend(node)
     *
     * Prepend one or more nodes to root node.
     *
     * @param {object} node - DOM node or array thereof
     */
